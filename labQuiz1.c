...
// Write your name here: Jonas Turner
// your UCFID: 4852668
...
{
    /*this function takes the head of a linked list and return the sum of all the data in the linked list.
      using loops is totally fine, however, if you want you can write a recursive function.
    */
    int sum = 0;
    ...
    return sum; //this is a dummy return. Remove it when you write your function.
};
...
node* BackToFrontMove (node * root)
{
    ...
    return root; //this is a dummy line. Remove this line when you write your code.
}
